...
#define CONNECTED_LED_PIN_NO 			BSP_LED_0
#define DEVICE_NAME                      "Yiyo-Link_200-TEST"                            /**< Name of device. Will be included in the advertising data. */
...
//            if ((data_array[index - 1] == '\n') || (index >= (BLE_NUS_MAX_DATA_LEN)))
				if (( data_array[index - 1] == '\x00') || (index >= (BLE_NUS_MAX_DATA_LEN)))
            {
